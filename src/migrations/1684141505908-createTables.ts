...
export class createTables1684141505908 implements MigrationInterface {
    name = 'createTables1684141505908'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`
            CREATE TABLE "qchat"."group_details" (
                ...
                "group_pic" TIMESTAMP NOT NULL,
                "admins" text array NOT NULL,
